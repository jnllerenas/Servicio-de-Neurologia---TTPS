 ...
 */
//, indexes={@ORM\Index(name="FK_imagen", columns={"estudio_id"})}
...
class Imagen {
    ...
    public function addEstudio(Estudio $estudio)
{            
     ...
     * @var \Estudio
     *
     * @ORM\ManyToOne(targetEntity="Estudio", inversedBy="imagenes")
     * @ORM\JoinColumns({
...
//     * Get estudio
//     *
//     * @return \Neurologia\Estudio\Entity\Estudio 
//     */
