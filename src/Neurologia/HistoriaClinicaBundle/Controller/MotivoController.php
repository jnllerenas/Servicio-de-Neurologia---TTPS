...
class MotivoController extends Controller {
    ...
    public function indexAction() {
        ...
        $params = array();
        $params['motivo'] = $em->getRepository('NeurologiaBDBundle:Motivo')->findby(array('historiaClinica' => $historiaid,));
        if (!$params['motivo']) {
    ...
    public function nuevoAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            $historia = $em->merge($_SESSION['historia']);
            return $this->redirect($this->generateUrl('neurologia_historia_clinica_homepage', array('accion' => 'motivo_listar', 'tab' => 'Motivo')));
        }
