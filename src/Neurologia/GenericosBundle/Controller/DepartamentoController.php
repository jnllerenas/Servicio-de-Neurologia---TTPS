...
use Neurologia\GenericosBundle\Entity\Departamento;
...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NeurologiaGenericosBundle:Departamento')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NeurologiaGenericosBundle:Departamento')->find($id);
