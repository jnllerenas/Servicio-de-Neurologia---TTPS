...
class Paciente
{
     ...
     *
     * @param \Neurologia\AntecedenteBundle\Entity\NivelEducacional $nivelEducacional
     * @return Paciente
     */
    public function setNivelEducacional(\Neurologia\AntecedenteBundle\Entity\NivelEducacional $nivelEducacional = null)
    {
     ...
     *
     * @return \Neurologia\AntecedenteBundle\Entity\NivelEducacional 
     */
     ...
     * Set obraSocial
     *
     * @param \Neurologia\AntecedenteBundle\Entity\ObraSocial $obraSocial
     * @return Paciente
     */
    public function setObraSocial(\Neurologia\AntecedenteBundle\Entity\ObraSocial $obraSocial = null)
    {
     ...
     * Get obraSocial
     *
     * @return \Neurologia\AntecedenteBundle\Entity\ObraSocial 
     */
     ...
     * Set estadoCivil
     *
     * @param \Neurologia\AntecedenteBundle\Entity\EstadoCivil $estadoCivil
     * @return Paciente
     */
    public function setEstadoCivil(\Neurologia\AntecedenteBundle\Entity\EstadoCivil $estadoCivil = null)
    {
     ...
     * Get estadoCivil
     *
     * @return \Neurologia\AntecedenteBundle\Entity\EstadoCivil 
     */
     ...
     * Set tipoDocumento
     *
     * @param \Neurologia\AntecedenteBundle\Entity\TipoDocumento $tipoDocumento
     * @return Paciente
     */
    public function setTipoDocumento(\Neurologia\AntecedenteBundle\Entity\TipoDocumento $tipoDocumento = null)
    {
     ...
     * Get tipoDocumento
     *
     * @return \Neurologia\AntecedenteBundle\Entity\TipoDocumento 
     */
     ...
     * Set admitidoPor
     *
     * @param \Neurologia\AntecedenteBundle\Entity\User $admitidoPor
     * @return Paciente
     */
    public function setAdmitidoPor(\Neurologia\AntecedenteBundle\Entity\User $admitidoPor = null)
    {
     ...
     * Get admitidoPor
     *
     * @return \Neurologia\AntecedenteBundle\Entity\User 
     */
     ...
     * Set derivadoPor
     *
     * @param \Neurologia\AntecedenteBundle\Entity\Departamento $derivadoPor
     * @return Paciente
     */
    public function setDerivadoPor(\Neurologia\AntecedenteBundle\Entity\Departamento $derivadoPor = null)
    {
     ...
     * Get derivadoPor
     *
     * @return \Neurologia\AntecedenteBundle\Entity\Departamento 
     */
     ...
     * Set sexo
     *
     * @param \Neurologia\AntecedenteBundle\Entity\Sexo $sexo
     * @return Paciente
     */
    public function setSexo(\Neurologia\AntecedenteBundle\Entity\Sexo $sexo = null)
    {
        $this->sexo = $sexo;
     ...
     * Get sexo
     *
     * @return \Neurologia\AntecedenteBundle\Entity\Sexo 
     */
